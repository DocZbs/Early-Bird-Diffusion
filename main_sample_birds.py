...
from runner.diffusion_joint_eb_masks import Diffusion
...
def parse_args_and_config():
    ...
    parser.add_argument("--sr", action="store_true", help="Whether to test the model")
    ...
    # bird path
    parser.add_argument('--bird_pruned_model_path',type=str,help="path to path of the pruned bird you want to train")
    # lower bound
    parser.add_argument('--ts_lower_bound',type=int,help='timestep lower bound')
    # upper bound
    parser.add_argument('--ts_upper_bound',type=int,help='timestep upper bound')
